    ...
    return [
        {
            ...
            "assets": [
                ...
                {
                    "type": "PHOTOVOLTAIC",  # link deze aan ETM
                    "etm_key": "Solar panels for building, 0 kWp",
                    "name": "Building_solarpanels_0kWp",
                    "category": "PRODUCTION",
                    "capacityElectricity_kW": 0.0,  # DEZE
                },
                {
                    "type": "GAS_BURNER",  # link deze aan ETM
                    "eta_r": 0.95,
                    "etm_key": None,
                    "name": "Building_gas_burner_60kW",
                    "category": "CONVERSION",
                    "deliveryTemp_degc": 90.0,
                    "capacityHeat_kW": 60.0,  # DEZE
                },
            ],
            "category": "BUILDING",  # EN DEZE
            ...
            "assets": [
                {
                    ...
                    "category": "PRODUCTION",
                    "capacityElectricity_kW": 1000.0,  # DEZE
                },
                {
                    "type": "PHOTOVOLTAIC",  # link deze aan ETM
                    "etm_key": "Solar field 1 MW",
        ...
        },
        {
            ...
            "assets": [
                {
                    "type": "STORAGE_ELECTRIC",  # link deze aan ETM
                    "stateOfCharge_r": 1.0,
                    "etm_key": None,
...
def etm_output():
    return {
        ...
        "depreciation_costs_wind_farm_per_kw": 10,
...
def holon_output():
    return [
        {
            "HSMSPeakLoadElectricity_kW": 1100.43,  # keer iets wat uit het etm komt || INFRA
            "MSLSPeakLoadElectricity_kW": 1100.43,  # keer iets wat uit het etm komt || INFRA
            "timesOfNodePeakLoads_h": {"E1": 1083.0, "E2": 1083.0},
            # CARRIERS
            # onderstaande profielen ook van elkaar af voor netto import en dan keer
            # een profiel van etm met uurlijkse prijs. en dan sommeren
            ...
            "SystemHourlyElectricityExport_MWh": {
                "0": 109.72,
                "1": 0.0,
                "2": 0.0,
                "3": 0.0,
            ...
            "checkSumHourlyElectricityImport_MWh": 5764.33,
            "checkSumHourlyElectricityExport_MWh": 129.66,
            "totalElectricityImport_MWh": 5764.33,
            "totalElectricityExport_MWh": 129.66,
            "totalMethaneImport_MWh": 0.0,  # import - export (netto) keer iets uit etm
            "totalMethaneExport_MWh": 0.0,
            "totalHydrogenImport_MWh": 0.0,  # import - export (netto) keer iets uit etm
            "totalHydrogenExport_MWh": 0.0,
            "totalBatteryUnitsInstalled": {"Grid_battery_10MWh": 1.0, "EHGV": 4.0},
            "totalBatteryChargeAmount_MWh": {
                "Grid_battery_10MWh": 2227.501005915215,
                "EHGV": 481.04,
            },
            "totalBatteryDischargeAmount_MWh": {
                "Grid_battery_10MWh": 2231.219736384883,
                "EHGV": 0.0,
            },
            "totalBatteryInstalledCapacity_MWh": {
                "Grid_battery_10MWh": 10.0,
                "EHGV": 2.0,
            },
        }
    ]
